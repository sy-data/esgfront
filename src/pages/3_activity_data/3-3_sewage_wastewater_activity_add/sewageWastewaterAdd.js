...
const SewageWastewaterAdd = () => {
  ...
  const onSearch = useCallback(() => {
    ...
    setSewageWastwaterInformation(baseYearActivityInfomationAtomDummyData);
...
export default SewageWastewaterAdd;
